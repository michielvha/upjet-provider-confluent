...
type ClusterEnvironmentInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/michielvha/upjet-provider-confluent/apis/cluster/environment/v1alpha1.Environment
	ID *string `json:"id,omitempty" tf:"id,omitempty"`

	// Reference to a Environment in environment to populate id.
	// +kubebuilder:validation:Optional
	IDRef *v1.NamespacedReference `json:"idRef,omitempty" tf:"-"`

	// Selector for a Environment in environment to populate id.
	// +kubebuilder:validation:Optional
...
type ClusterObservation struct {
	...
	// The list of endpoints for connecting to the Kafka cluster. These endpoints provide different network access methods or regions for connecting to the cluster:
...
type EndpointsObservation struct {
	...
	// The ID of the Access Point that the endpoint corresponds to. Access Point IDs PUBLIC and PRIVATE_LINK are reserved.
	AccessPointID *string `json:"accessPointId,omitempty" tf:"access_point_id,omitempty"`

	// The bootstrap endpoint used by Kafka clients to connect to the Kafka cluster. (e.g., SASL_SSL://pkc-00000.us-central1.gcp.confluent.cloud:9092).
	BootstrapEndpoint *string `json:"bootstrapEndpoint,omitempty" tf:"bootstrap_endpoint,omitempty"`

	// The type of connection used for the endpoint (for example, PRIVATE_NETWORK_INTERFACE).
