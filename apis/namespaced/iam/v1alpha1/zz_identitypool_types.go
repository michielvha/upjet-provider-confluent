...
type IdentityProviderInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/michielvha/upjet-provider-confluent/apis/cluster/iam/v1alpha1.IdentityProvider
	ID *string `json:"id,omitempty" tf:"id,omitempty"`

	// Reference to a IdentityProvider in iam to populate id.
	// +kubebuilder:validation:Optional
	IDRef *v1.NamespacedReference `json:"idRef,omitempty" tf:"-"`

	// Selector for a IdentityProvider in iam to populate id.
	// +kubebuilder:validation:Optional
