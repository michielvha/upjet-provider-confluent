...
type ConnectorInitParameters struct {
	...
	ConfigSensitive map[string]*string `json:"configSensitiveSecretRef,omitempty" tf:"-"`
...
type ConnectorParameters struct {
	...
	// +kubebuilder:validation:Optional
	ConfigSensitiveSecretRef *v1.LocalSecretReference `json:"configSensitiveSecretRef,omitempty" tf:"-"`
