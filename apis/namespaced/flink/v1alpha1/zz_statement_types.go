...
type StatementInitParameters struct {
	...
	PropertiesSensitive map[string]*string `json:"propertiesSensitiveSecretRef,omitempty" tf:"-"`
...
type StatementParameters struct {
	...
	// +kubebuilder:validation:Optional
	PropertiesSensitiveSecretRef *v1.LocalSecretReference `json:"propertiesSensitiveSecretRef,omitempty" tf:"-"`
